...
set INCLUDE= ../include
set ASM_SRC= startup.s
set C_SRC= ../uart16550_driver/uart16550_driver.c
set LINK_OBJ= main.c init.c
set LDFLAG= -T ../link.lds -nostartfiles -Wl,--gc-sections -Wl,--check-sections
::complie
%GCC_PATH%riscv-nuclei-elf-gcc %C_FLAG% -I %INCLUDE% %ASM_SRC% %C_SRC% %LINK_OBJ% -o main.exec %LDFLAG%
